...
2. Run the skill end-to-end. Since v0.2 the default output is the two-level **Floral Design Presentation Package**: LEVEL 1 Floral Design Board (all eight parts) → LEVEL 2 Final Bouquet Visualization.
